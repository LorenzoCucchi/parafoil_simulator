...
Matrix<double, 6, 6> PopA(Matrix3d A1,Matrix3d A2,Matrix3d A3,Matrix3d A4){
    Matrix<double, 6, 6> pop;
    pop.block<3, 3>(0, 0) = A1;
    pop.block<3, 3>(0, 3) = A2;
    pop.block<3, 3>(3, 0) = A3;
    pop.block<3, 3>(3, 3) = A4;
    return pop;
}